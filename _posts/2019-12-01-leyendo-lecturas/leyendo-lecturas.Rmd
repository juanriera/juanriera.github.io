...
* cambiar de signo la diferencia calculada, para que sea la más reciente menos la más antigua

* añadir como primer término un valor *NA* ya que la serie diferenciada tiene un término menos, y el primero en realidad no existe (el primer término de la serie diferenciada es la diferencia entre el segundo y el primero, por lo que no hay un primero)
...
+ Ver si es posible disponer de lecturas más frecuentes, diarias o incluso horarias

+ Pasar las lecturas a valor en euros
