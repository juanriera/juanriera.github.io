...
Como he utilizado la opción `as.sis = TRUE` para evitar cargar columnas como factores, la fecha se ha cargado como texto. Cambio el formato a `POSIXct`, y añado la hora dentro del campo de fecha. Esto facilitará la preparación de las gráficas temporales.
...
Para echar una primera mirada a los datos, voy a utilizar `plotly`, que me permite ver los valores individualmente colocando el cursor sobre ellos.
...
Mi casa tiene calefacción central, pero tiene un inconveniente, y es que mira al norte. Por esta razón, tiende a ser fría. Además, mis vecinos suelen ser ahorradores y los administradores de la comunidad de vecinos sólo encienden la calefacción por la tarde. Como la casa se enfría de noche, a media mañana, después de ventilar, tenemos que encender las estufas eléctricas, hasta que la casa vuelve a calentarse con la calefacción central Es cierto que este mes ha hecho mucho frío y ha llovido mucho, es posible que hayamos encendido la calefacción eléctrica más que los años anteriores, parece que los boxplot de noviembre y diciembre de 2019 muestran valores más altos que los de 2017 tanto para la mediana como para la caja 25%-75%. Estamos consumiendo más. 
...
Bien aunque la gráfica es bastante informativa, hay tantos valores que no resulta nada clara.
...
Finalmente, tengo interés en ver si desde noviembre hemos subido el consumo, esto es si en estos dos meses se puede detectar una tendencia al alza.
